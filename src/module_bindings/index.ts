...
import SessionMemberRow from "./session_member_table";
...
const tablesSchema = __schema({
  audio_frame: __table({
    ...
    constraints: [
      { name: 'audio_frame_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, AudioFrameRow),
  session: __table({
    name: 'session',
  ...
  session_member: __table({
    ...
    constraints: [
      { name: 'session_member_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, SessionMemberRow),
});
